(function (root, factory) {
    ...
    return { WIDTH, HEIGHT, GRAVITY, TANK_W, TANK_H, PROJECTILE_R, STARTING_HEALTH, DAMAGE, TERRAIN_STEP, BARRIER_CELL, DEFAULT_BLAST, DEFAULT_WEAPON, WEAPON_REGISTRY, POWER_UP_CATALOG, PICKUP_IDS, PICKUP_SIZE, INVENTORY_LIMIT, MAX_PICKUPS, SPAWN_EVERY_TURNS, ARENA_LIMITS, seededRandom, generateArena, terrainHeightAt, tankYAt, barrierOccupiedAt, settleTanks, resolveExplosion, isValidPickupPosition, spawnPickup, collectPickup, activatePowerUp, applyDamage, beginTurnEffects, endTurnEffects, expireEffects, advancePickupSchedule, createInitialState, beginTurn, tankBounds, moveTank, adjustAim, adjustPower, selectWeapon, fireProjectile, predictProjectile, collisionAt, nearestLaserHit, resolveLaser, stepPhysics, resolveShot, resetMatch, snapshot };
}));
